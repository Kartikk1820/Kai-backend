...
from .views import (
    TaskViewSet, TaskBoardView, TaskFilterOptionsView, TaskAssigneeCountsView,
    TeamViewSet, SprintViewSet, BacklogView, PersonalBacklogItemViewSet,
)
...
personal_backlog_router = SimpleRouter()
personal_backlog_router.register(r'personal-backlog', PersonalBacklogItemViewSet, basename='personal-backlog')
...
urlpatterns = [
    ...
    path('', include(personal_backlog_router.urls)),
